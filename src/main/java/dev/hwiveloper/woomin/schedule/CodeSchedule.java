package dev.hwiveloper.woomin.schedule;
...
import dev.hwiveloper.woomin.common.LogUtil;
import dev.hwiveloper.woomin.domain.assembly.Orig;
import dev.hwiveloper.woomin.domain.assembly.Poly;
import dev.hwiveloper.woomin.domain.common.Edu;
import dev.hwiveloper.woomin.domain.common.EduPK;
import dev.hwiveloper.woomin.domain.common.Election;
import dev.hwiveloper.woomin.domain.common.ElectionPK;
import dev.hwiveloper.woomin.domain.common.Gusigun;
import dev.hwiveloper.woomin.domain.common.GusigunPK;
...
import dev.hwiveloper.woomin.domain.common.Sungeogu;
import dev.hwiveloper.woomin.domain.common.SungeoguPK;
import dev.hwiveloper.woomin.repository.EduRepository;
import dev.hwiveloper.woomin.repository.ElectionRepository;
import dev.hwiveloper.woomin.repository.GusigunRepository;
import dev.hwiveloper.woomin.repository.JobRepository;
import dev.hwiveloper.woomin.repository.OrigRepository;
import dev.hwiveloper.woomin.repository.PartyRepository;
import dev.hwiveloper.woomin.repository.PolyRepository;
import dev.hwiveloper.woomin.repository.ReeleGbnRepository;
import dev.hwiveloper.woomin.repository.SungeoguRepository;
